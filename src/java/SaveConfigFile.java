...
public class SaveConfigFile extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Configuraciones configuraciones = gson.fromJson(new FileReader(configFile), Configuraciones.class);
            
            //Adds the new configuration to the configurations
            configuraciones.addConfiguracion(new Configuracion(nombre, tipoNave, Boolean.valueOf(modoDificil)));
